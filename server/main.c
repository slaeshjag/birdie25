...
void server_start() {
	...
	set_planet(25, 0, 52.0, 74, 10000.0, 0.1);
	set_planet(26, 1, 303.0, 74, 10000.0, 0.1);
	set_planet(27, 1, 64.0, 74, 10000.0, 0.1);
	set_planet(28, 2, 35.0, 74, 10000.0, 0.1);
	set_planet(29, 2, 86.0, 74, 10000.0, 0.1);
	set_planet(30, 3, 37.0, 74, 10000.0, 0.1);
	set_planet(31, 3, 58.0, 74, 10000.0, 0.1);
	set_planet(32, 4, 29.0, 74, 10000.0, 0.1);
	set_planet(33, 4, 50.0, 74, 10000.0, 0.1);
	set_planet(34, 5, 21.0, 74, 10000.0, 0.1);
	set_planet(35, 5, 72.0, 74, 10000.0, 0.1);
	set_planet(36, 6, 33.0, 74, 10000.0, 0.1);
	set_planet(37, 6, 44.0, 74, 10000.0, 0.1);
	set_planet(38, 7, 35.0, 74, 10000.0, 0.1);
	set_planet(39, 7, 60.0, 74, 10000.0, 0.1);
